...
// 致命错误位位于bit0,这里使用位移宏展开,避免宏自引用导致后续使用时报错。
 ...
 * BMI088初始化错误码。
 *
 * 这些值会被按位或组合,因此必须使用互不重叠的bit mask。
 * 这样日志里的error=0x...可以准确表示多个寄存器/链路同时失败。
 */
typedef uint16_t BMI088_ERORR_CODE_e;

#define BMI088_NO_ERROR 0x0000U
#define BMI088_ACC_PWR_CTRL_ERROR ((BMI088_ERORR_CODE_e)(1U << 0U))
#define BMI088_ACC_PWR_CONF_ERROR ((BMI088_ERORR_CODE_e)(1U << 1U))
#define BMI088_ACC_CONF_ERROR ((BMI088_ERORR_CODE_e)(1U << 2U))
#define BMI088_ACC_SELF_TEST_ERROR ((BMI088_ERORR_CODE_e)(1U << 3U))
#define BMI088_ACC_RANGE_ERROR ((BMI088_ERORR_CODE_e)(1U << 4U))
#define BMI088_INT1_IO_CTRL_ERROR ((BMI088_ERORR_CODE_e)(1U << 5U))
#define BMI088_INT_MAP_DATA_ERROR ((BMI088_ERORR_CODE_e)(1U << 6U))
#define BMI088_GYRO_RANGE_ERROR ((BMI088_ERORR_CODE_e)(1U << 7U))
#define BMI088_GYRO_BANDWIDTH_ERROR ((BMI088_ERORR_CODE_e)(1U << 8U))
#define BMI088_GYRO_LPM1_ERROR ((BMI088_ERORR_CODE_e)(1U << 9U))
#define BMI088_GYRO_CTRL_ERROR ((BMI088_ERORR_CODE_e)(1U << 10U))
#define BMI088_GYRO_INT3_INT4_IO_CONF_ERROR ((BMI088_ERORR_CODE_e)(1U << 11U))
#define BMI088_GYRO_INT3_INT4_IO_MAP_ERROR ((BMI088_ERORR_CODE_e)(1U << 12U))
#define BMI088_SELF_TEST_ACCEL_ERROR ((BMI088_ERORR_CODE_e)(1U << 13U))
#define BMI088_SELF_TEST_GYRO_ERROR ((BMI088_ERORR_CODE_e)(1U << 14U))
#define BMI088_NO_SENSOR ((BMI088_ERORR_CODE_e)(1U << 15U))
