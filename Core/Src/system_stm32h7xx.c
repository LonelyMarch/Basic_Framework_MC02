...
/**
  * @brief  Exit Run* mode by applying the selected power supply configuration.
  *         This function is called from startup code before SystemInit().
  * @param  None
  * @retval None
  */
